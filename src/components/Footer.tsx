...
export default  function Footer() {
  ...
  return (
      ...
      <footer className="e">
        <div className="max-w-4xl md:max-w-[800px] w-full px-3 xl:p-0 my-5 mx-auto border-t py-6">
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-3">
            <div>
              ...
              <p className="mt-4 max-w-xs text-gray-500">
                <span>
                Built with <Link className="underline hover:text-slate-400 transition-colors duration-300" href="">Nextjs</Link>, <Link className="hover:underline hover:text-slate-400 transition-colors duration-300" href="">Tailwind</Link> and <Link className="hover:underline hover:text-slate-400 transition-colors duration-300" href="">shadcn</Link>. Hosted on <Link className="hover:underline hover:text-slate-400 transition-colors duration-300" href="">Vercel</Link>. The source code is available on <Link className="hover:underline hover:text-slate-400 transition-colors duration-300" href="">GitHub</Link>.
                </span>
              </p>
