          ...
          <div className="grid px-7 grid-cols-1 gap-10 lg:grid-cols-3">
            <div>
              ...
              <p className="mt-4 max-w-xs text-gray-500">
                <span>
                Built with <Link className="underline hover:text-slate-400 transition-colors duration-300" href="https://nextjs.org">Nextjs</Link>, <Link className="hover:underline hover:text-slate-400 transition-colors duration-300" href="https://tailwindcss.com/">Tailwind</Link> and <Link className="hover:underline hover:text-slate-400 transition-colors duration-300" href="https://ui.shadcn.com">shadcn</Link>. Hosted on <Link className="hover:underline hover:text-slate-400 transition-colors duration-300" href="https://vercel.com">Vercel</Link>. The source code is available on <Link className="hover:underline hover:text-slate-400 transition-colors duration-300" href="https://github.com/Pawank06/web">GitHub</Link>.
                </span>
              </p>
              ...
              <ul className="mt-8 flex gap-6">
                ...
                <li>
                  <Link
                    href="https://twitter.com/akatrinetra" 
                    rel="noreferrer"
                    target="_blank"
                    className="text-gray-700 transition hover:opacity-75"
                  >
            ...
            <div className="grid mt-4 grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
              ...
              <div>
                ...
                <ul className="mt-6 space-y-4 text-sm">
                  <li>
                    <Link href="https://twitter.com/akatrinetra" target="_blank" className="text-gray-700 transition hover:opacity-75"> Twitter </Link>
                  </li>

                  <li>
                    <Link href="https://github.com/Pawank06" target="_blank" className="text-gray-700 transition hover:opacity-75"> GitHub </Link>
                  </li>
